...
public class AbstractStyleTableDemo extends AbstractDemo {
    ...
    private static final long serialVersionUID = -6381804475623031469L;
    ...
    class StyleTableTableModel extends DefaultTableModel implements StyleModel {
        private static final long serialVersionUID = -1231230601988353490L;
    ...
    public Component getDemoPanel() {
        ...
        _tableModel = new StyleTableTableModel(data, columnNames);
        _table = new SortableTable(_tableModel);
        CellStyle focusCellStyle = new CellStyle();
        focusCellStyle.setBorder(BorderFactory.createEtchedBorder(Color.green, Color.yellow));
        _table.setFocusCellStyle(focusCellStyle);
    ...
    public Component getOptionsPanel() {
        ...
        buttons[0] = new JRadioButton(new AbstractAction("Stock Style (green for up and red for down") {
            private static final long serialVersionUID = -8700770503141600330L;
        ...
        buttons[1] = new JRadioButton(new AbstractAction("Alert Style (for negative value)") {
            private static final long serialVersionUID = -4120341065601019297L;
        ...
        buttons[2] = new JRadioButton(new AbstractAction("Emphasize Style (for negative value)") {
            private static final long serialVersionUID = -7880314561336400278L;
        ...
        buttons[3] = new JRadioButton(new AbstractAction("Hidden text (for negative value)") {
            private static final long serialVersionUID = 3222121874460639281L;
        ...
        buttons[4] = new JRadioButton(new AbstractAction("None") {
            private static final long serialVersionUID = 9135866214893457640L;
