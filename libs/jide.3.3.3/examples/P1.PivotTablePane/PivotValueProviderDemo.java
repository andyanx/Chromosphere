/*
 * @(#)PivotValueProviderDemo.java 3/18/2010
 *
 ...
 */
public class PivotValueProviderDemo extends AbstractDemo {
    ...
    public PivotValueProviderDemo() {
    }

    public String getName() {
        return "PivotValueProvider Demo";
    }
    ...
    public String getDescription() {
        return "This demo also looks similar with PivotTableDemo.\n" +
                "It tries to show the possibility that you could move the heavy load calculation task to a separate task.\n" +
                "Demoed classes:\n" +
                "com.jidesoft.pivot.PivotValueProvider";
    }
    ...
    public Component getOptionsPanel() {
        ...
        final JButton getRowButton = new JButton(new AbstractAction("Get Row Expansion State") {
            private static final long serialVersionUID = 336632948491773282L;
        ...
        final JButton setRowButton = new JButton(new AbstractAction("Set Row Expansion State") {
            private static final long serialVersionUID = 6674931003215314024L;
        ...
        final JButton getColumnButton = new JButton(new AbstractAction("Get Column Expansion State") {
            private static final long serialVersionUID = 2945941497136862449L;
        ...
        final JButton setColumnButton = new JButton(new AbstractAction("Set Column Expansion State") {
            private static final long serialVersionUID = 5755086883410114612L;
...
//        final CalculatedTableModel calculatedTableModel = setupCustomerReportsCalculatedTableModel(tableModel);
        ...
        final CalculatedPivotDataModel pivotDataModel = setupProductDetailsPivotDataModel(calculatedTableModel);
...
//        });
    ...
    private CalculatedPivotDataModel setupProductDetailsPivotDataModel(TableModel derivedTableModel) {
...
//        final PivotDataModel pivotDataModel = new PivotDataModel(new CachedTableModel(derivedTableModel));
        final CalculatedPivotDataModel pivotDataModel = new CalculatedPivotDataModel(new TableModelPivotValueProvider(derivedTableModel), derivedTableModel);
...
//        });
        ...
        RunningSummary summary = new RunningSummary();
        summary.setRunningType(PivotConstants.RUNNING_SUMMARY_TOTAL);
        summary.setBaseOnField(pivotDataModel.getField("Month"));
        summary.setRangeInField(PivotConstants.RANGE_IN_TOTAL);
        summary.setCompareTo(PivotConstants.COMPARE_TO_PREVIOUS);
        List<RunningSummary> summaryList = new ArrayList<RunningSummary>();
        summaryList.add(summary);
        pivotDataModel.getField("ProductSales").setRunningSummaryList(summaryList);
    ...
    static public void main(String[] s) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                showAsFrame(new PivotValueProviderDemo());
            }
        });
    }
