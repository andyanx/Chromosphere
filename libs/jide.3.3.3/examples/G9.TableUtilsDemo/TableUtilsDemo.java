...
public class TableUtilsDemo extends AbstractDemo {
    private static final long serialVersionUID = 4447775129114398279L;
    ...
    public Component getOptionsPanel() {
        JButton saveSelectionButton = new JButton(new AbstractAction("Save Selection") {
            private static final long serialVersionUID = -7957291881253518937L;
        ...
        JButton loadSelectionButton = new JButton(new AbstractAction("Load Selection") {
            private static final long serialVersionUID = 2325425266424660667L;
        ...
        JButton savePrefButton = new JButton(new AbstractAction("Save Preference") {
            private static final long serialVersionUID = 7424128697294617256L;
        ...
        JButton loadPrefButton = new JButton(new AbstractAction("Load Preference") {
            private static final long serialVersionUID = -3927082705077379525L;
        ...
        JButton saveSortingPrefButton = new JButton(new AbstractAction("Save Sorting Orders") {
            private static final long serialVersionUID = 4188350273970049411L;
        ...
        JButton loadSortingPrefButton = new JButton(new AbstractAction("Load Sorting Orders") {
            private static final long serialVersionUID = 6004391235879484994L;
        ...
        JButton loadABCDEFModelButton = new JButton(new AbstractAction("ABCDEF") {
            private static final long serialVersionUID = -8250083792800475431L;
        ...
        JButton loadABCEFModelButton = new JButton(new AbstractAction("ABCEF") {
            private static final long serialVersionUID = -5813710189671986087L;
    ...
    public static class ColumnIdentifier {
        ...
        public ColumnIdentifier(String text) {
            _text = text;
        }
        ...
        public boolean equals(Object obj) {
            return obj instanceof ColumnIdentifier && JideSwingUtilities.equals(_text, ((ColumnIdentifier) obj)._text);
        }
    ...
    public static class SampleTableModel1 extends AbstractTableModel implements ColumnIdentifierTableModel {

        private static final long serialVersionUID = 7961714923437114104L;
        ...
        public Object getColumnIdentifier(int columnIndex) {
            return new ColumnIdentifier(getColumnName(columnIndex));
        }
    ...
    public static class SampleTableModel2 extends AbstractTableModel implements ColumnIdentifierTableModel {

        private static final long serialVersionUID = -599119302004962756L;
    ...
    public static class SampleTableModel3 extends AbstractTableModel implements ColumnIdentifierTableModel {

        private static final long serialVersionUID = 5144722369191721371L;
