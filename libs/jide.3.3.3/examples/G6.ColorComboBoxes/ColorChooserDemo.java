...
public class ColorChooserDemo extends AbstractDemo {
    public ColorExComboBox _colorComboBox;
    ...
    private ColorExComboBox createColorComboBox() {
        final ColorExComboBox colorComboBox = new ColorExComboBox();
        colorComboBox.setSelectedColor(Color.black);
        colorComboBox.setPrototypeDisplayValue(Color.WHITE);
    ...
    private JPanel createOptionsPanel() {
        ...
        final JCheckBox showCross = new JCheckBox("Show Cross Background for Null");
