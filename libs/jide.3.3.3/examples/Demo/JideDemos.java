...
public class JideDemos extends DockableBarDockableHolderPanel {
    ...
    public JideDemos(RootPaneContainer rootPaneContainer) {
        ...
        // add toolbar
        getDockableBarManager().addDockableBar(DemosCommandBarFactory.createMenuCommandBar(this));
        getDockableBarManager().addDockableBar(DemosCommandBarFactory.createLookAndFeelCommandBar(this));
...
//        LoggerUtils.enableLogger("java.awt.focus", Level.ALL);
        ...
        _frame = new JFrame("Demo of JIDE Products - JIDE " + Lm.getProductVersion() + " on JDK " + SystemInfo.getJavaVersion());
