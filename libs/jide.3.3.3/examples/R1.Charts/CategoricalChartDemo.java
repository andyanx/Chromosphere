...
public class CategoricalChartDemo extends AbstractDemo {
    ...
    public JPanel createDemo() {
        ...
        chart.setTitle(new AutoPositionedLabel("Chart with Categorical X Values", Color.blue, titleFont));
        ...
        ChartStyle redHighlightStyle = new ChartStyle(new Color(200, 0, 0),PointShape.DISC, 20).withPointsAndLines();
