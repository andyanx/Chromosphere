...
public class DifferentViewsDemo extends AbstractDemo {
    ...
    private JPanel createDemo() {
        ...
        demoPanel.setPreferredSize(new Dimension(565, 550));
        ...
        chart1.setBorder(new EmptyBorder(0, b, b, b));
        ...
        chart4.setBorder(new EmptyBorder(0, b, b, b));
