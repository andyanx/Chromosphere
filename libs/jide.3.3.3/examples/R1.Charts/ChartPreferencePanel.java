...
public class ChartPreferencePanel extends JPanel {
    ...
    private ColorExComboBox lineColorsChooser = createColorExComboBox();
    private ColorExComboBox pointColorsChooser = createColorExComboBox();
    ...
    private ColorExComboBox createColorExComboBox() {
        final ColorExComboBox ColorExComboBox = new ColorExComboBox();
        ColorExComboBox.setPreferredSize(controlSize);
        ColorExComboBox.setSelectedColor(Color.black);
        ColorExComboBox.setAllowMoreColors(false);
        ColorExComboBox.setColorValueVisible(false);
        ColorExComboBox.setAllowDefaultColor(false);
