...
public class ConfigurableBarChartDemo extends AbstractDemo {
    ...
    private JPanel createDemo() {
        chart = new Chart();
        chart.setBorder(new EmptyBorder(0,0,0,20));
    ...
    private void useColorHighlights() {
        ...
        chart.setHighlightStyle(red.getHighlight(), new ChartStyle(red.getColor()).withBars());
        chart.setHighlightStyle(orange.getHighlight(), new ChartStyle(orange.getColor()).withBars());
        chart.setHighlightStyle(yellow.getHighlight(), new ChartStyle(yellow.getColor()).withBars());
        chart.setHighlightStyle(green.getHighlight(), new ChartStyle(green.getColor()).withBars());
        chart.setHighlightStyle(cyan.getHighlight(), new ChartStyle(cyan.getColor()).withBars());
        chart.setHighlightStyle(indigo.getHighlight(), new ChartStyle(indigo.getColor()).withBars());
        chart.setHighlightStyle(violet.getHighlight(), new ChartStyle(violet.getColor()).withBars());
    }
