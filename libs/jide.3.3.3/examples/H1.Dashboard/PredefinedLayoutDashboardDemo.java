/*
 * @(#)PredefinedLayoutDashboardDemo.java 12/21/2010
 *
...
public class PredefinedLayoutDashboardDemo extends AbstractDemo {
    ...
    public PredefinedLayoutDashboardDemo() {
    }

    public String getName() {
        return "Dashboard Demo (using Pre-defined Layout)";
    }
    ...
    public String getDescription() {
        return "This is a demo of Dashboard using pre-defined layout. \n" +
                "\n" +
                "Demoed classes:\n" +
                "com.jidesoft.dasbhoard.PredefinedLayoutAdapter";
    }
...
//                toolBarComponent.add(new JideButton("My Button"));
            ...
            public Dashboard createDashboard(String key) {
                Dashboard dashboard = super.createDashboard(key);
                dashboard.setLayoutAdapter(new PredefinedMigLayoutAdapter());
                return dashboard;
            }
...
//                palette.setButtonLayout(new GridLayout(2, 0)); // you could uncomment this to have two rows of gadget buttons
        ...
        dashBoard.setPredefinedLayout(new MigLayout());
//        dashBoard.addPlaceHolder("width 50:100:200");
        dashBoard.addPlaceHolder("grow 1");
        dashBoard.addPlaceHolder("grow 1");
        dashBoard.addPlaceHolder("wrap, grow 1");
        dashBoard.addPlaceHolder("span 2, grow 2");
        dashBoard.addPlaceHolder("wrap, grow 1");
        dashBoard.addPlaceHolder("span, grow");

        _tabbedPane.setUseFloatingPalette(true);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                showAsFrame(new PredefinedLayoutDashboardDemo());
            }
        });
    }
        ...
        AbstractGadget dashboardElement = new AbstractGadget(key,
            ...
            public GadgetComponent createGadgetComponent() {
                ...
                gadget._maximizeButton.addActionListener(new AbstractAction() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        gadget.getGadget().getGadgetManager().maximizeGadgetComponent(gadget);
                ...
                gadget._restoreButton.addActionListener(new AbstractAction() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        gadget.getGadget().getGadgetManager().restoreGadgetComponent();
