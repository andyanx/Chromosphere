...
public class CollapsiblePaneSingleDashboardDemo extends AbstractDemo {
    ...
    public Component getDemoPanel() {
        ...
        _dashboardHolder.setRowResizable(true);
...
//                    DashboardPersistenceUtils.save(tabbedPane, "C:\\dashboard.xml");
        ...
        JCheckBox rowResizable = new JCheckBox("Row Resizable");
        rowResizable.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                _dashboardHolder.setRowResizable(e.getStateChange() == ItemEvent.SELECTED);
            }
        });
        rowResizable.setSelected(_dashboardHolder.isRowResizable());
        buttonPanel.add(rowResizable);
