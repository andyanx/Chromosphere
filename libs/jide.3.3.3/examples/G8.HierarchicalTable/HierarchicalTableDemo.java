...
public class HierarchicalTableDemo extends AbstractDemo {
    ...
    private HierarchicalTable createTable() {
        ...
        table.setComponentFactory(new HierarchicalTableComponentFactory() {
            Map<Integer, TableModel> _tableModels = new HashMap<Integer, TableModel>();
            Map<Integer, JTable> _tables = new HashMap<Integer, JTable>();
            ...
            private JComponent createPanel(final TableModel model, final int row) {
                ...
                Thread thread = new Thread() {
                    ...
                    public void run() {
                        super.run();
                        try {
                            Thread.sleep(3000); // you could use this thread to calculate your table model.
                        }
