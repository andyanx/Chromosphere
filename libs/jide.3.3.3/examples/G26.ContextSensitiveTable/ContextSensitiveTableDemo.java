...
/**
 * Demoed Component: {@link com.jidesoft.grid.ContextSensitiveTable} <br> Required jar files: jide-common.jar,
            ...
            public CellEditor create() {
                ColorCellEditor editor = new ColorCellEditor() {
                    ...
                    protected ColorExComboBox createColorComboBox() {
                        ColorExComboBox colorComboBox = super.createColorComboBox();
