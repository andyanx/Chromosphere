...
public class JideTableDemo extends AbstractDemo {
    ...
    public Component getOptionsPanel() {
        ...
        autoFilterCheckBox.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                ((NestedTableHeader) _table.getTableHeader()).setAutoFilterEnabled(e.getStateChange() == ItemEvent.SELECTED);
                ((NestedTableHeader) _table.getTableHeader()).setUseNativeHeaderRenderer(true);
            }
        });
        autoFilterCheckBox.setSelected(((NestedTableHeader) _table.getTableHeader()).isAutoFilterEnabled());
        panel.add(autoFilterCheckBox);
